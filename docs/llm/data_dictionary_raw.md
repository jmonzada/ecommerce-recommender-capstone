...
| Column | Type | Missing % | Description | Units / allowed values |
|---|---|---|---|---|
| review_id | object | 0.0 | Unique identifier of the review submitted by the customer. | Hash string |
...
| product_name_lenght | float64 | 1.9 | Character count of the product name. | Number of characters |
| product_description_lenght | float64 | 1.9 | Character count of the product description. | Number of characters |
| product_photos_qty | float64 | 1.9 | Number of photos published for the product. | Count |
| product_weight_g | float64 | 0.0 | Weight of the product. | Grams |
